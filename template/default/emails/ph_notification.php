<?php include 'includes/header.php';?>
    ...
    <div style="font-family: Arial, sans-serif; line-height: 20px; color: #444444; font-size: 13px;">
      ...
      <br>
      <br>
       <a href="<?=domain;?>/user/gh_matches/<?=$match->gh->id;?>" style="color: #ffffff; text-decoration: none; margin: 0px; text-align: center; vertical-align: baseline; padding: 9px 9px; font-size: 15px; line-height: 21px; background-color: #32c89a;">&nbsp; Go to Dashboard &nbsp;</a>
       <br>
       <br>
    </div>
